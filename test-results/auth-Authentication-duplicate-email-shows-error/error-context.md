...
- Name: auth.spec.js >> Authentication >> duplicate email shows error
- Location: tests\ui\auth.spec.js:25:5
...
```yaml
- text: CalTrack create your account email already in use name
- textbox "name":
